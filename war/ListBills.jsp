    		...
    		<ul class="nav nav-tabs">
      			<li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> Users Management <b class="caret"></b> </a>
        			<ul class="dropdown-menu">
        			    ...
        			    <li class="dropdown"><a href='#' onclick='invokeServlet("DataController?action=listPurchaseOrders")' data-toggle="tab">Commandes</a></li>
        			    <li class="dropdown"><a href='#' onclick='invokeServlet("DataController?action=listBills")' data-toggle="tab">Factures</a></li>
        			</ul>
      			</li>	
